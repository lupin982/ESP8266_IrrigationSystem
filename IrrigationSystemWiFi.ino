...
void page_get_info()
{
  ...
  page_out += "<html>";
  page_out += "<head>";
  page_out += "<meta name='viewport' content='width=device-width'>";
...
void page_set_start()
{
  ...
  page_out += "<form name='set_start' method=\"post\" action='/setStart' id='Form1'>";
  page_out += "<input type='text' id='le_startOre' style='position:absolute;left:96px;top:17px;width:190px;height:15px;line-height:15px;z-index:1;' name='le_startOre' value='" + String(start_hour) + "' spellcheck='false' onchange='validateHh(this);'>";
  ...
  page_out += "<input type='text' id='le_startMinuti' style='position:absolute;left:96px;top:49px;width:190px;height:15px;line-height:15px;z-index:4;' name='le_startMinuti' value='" + String(start_minute) + "' spellcheck='false' onchange='validateMm(this);'>";
  ...
  page_out += "<input type='text' id='le_durata' style='position:absolute;left:96px;top:82px;width:190px;height:15px;line-height:15px;z-index:3;' name='le_durata' value='" + String(duration_hours * 60 + duration_minutes) + "' spellcheck='false' onchange='validateDurata(this);'>";
